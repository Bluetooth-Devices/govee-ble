...
GVH5140_SERVICE_INFO = BluetoothServiceInfo(
    name="GV5140303A",
    address="0C:4E:A0:DB:30:3A",
    manufacturer_data={1: b"\x01\x01\x03=\xee\x02>\x00"},
    service_uuids=["0000ec88-0000-1000-8000-00805f9b34fb"],
    service_data={},
    source="local",
    rssi=-71,
...
GVH5140_SERVICE_INFO_2 = BluetoothServiceInfo(
    name="GV5140303A",
    address="0C:4E:A0:DB:30:3A",
    manufacturer_data={1: b"\x01\x01\x03\x1a\xbd\x02]\x00"},
    service_uuids=["0000ec88-0000-1000-8000-00805f9b34fb"],
    service_data={},
    source="local",
    rssi=-75,
...
GVH5140_SERVICE_INFO_3 = BluetoothServiceInfo(
    name="GV5140303A",
    address="0C:4E:A0:DB:30:3A",
    manufacturer_data={1: b"\x01\x01\x03\x1a\xbc\x02X\x00"},
    service_uuids=["0000ec88-0000-1000-8000-00805f9b34fb"],
    service_data={},
    source="local",
    rssi=-77,
...
GVH5140_SERVICE_INFO_ERROR = BluetoothServiceInfo(
    name="GV5140303A",
    address="0C:4E:A0:DB:30:3A",
    manufacturer_data={1: b"\x01\x01\x03\x1a\xbc\x02X\x01"},
    service_uuids=["0000ec88-0000-1000-8000-00805f9b34fb"],
    service_data={},
    source="local",
    rssi=-77,
...
GVH5106_FREEZING_SERVICE_INFO = BluetoothServiceInfo(
    name="GVH5106_4E05",
    address="CC:32:37:35:4E:05",
    rssi=-66,
    # data[2:6] == 0x81867cd8: high bit flags a negative temperature; the
    # remaining bits decode to -2.5 °C / 59.1 % / 0 µg/m³ (mirrors the positive
    # GVH5106_SERVICE_INFO fixture with the freezing flag set).
    manufacturer_data={1: b"\x01\x01\x81\x86\x7c\xd8"},
    service_uuids=["0000ec88-0000-1000-8000-00805f9b34fb"],
    service_data={},
    source="local",
)
...
GVH5106_INVALID_SERVICE_INFO = BluetoothServiceInfo(
    name="RZSS",
...
GVH5110_SERVICE_INFO_2 = BluetoothServiceInfo(
    ...
    rssi=-56,
    manufacturer_data={
        1: b"\x01\x01\x03\x8e\xfedL\x00\x02\x15INTELLI_ROCKS_HWPu\xf2\xff\x0c"
    },
    service_uuids=["0000ec88-0000-1000-8000-00805f9b34fb"],
    service_data={},
    source="local",
...
GVH5121_MOTION_SERVICE_INFO = BluetoothServiceInfo(
    name="GV5121195A",
...
GVH5121_MOTION_SERVICE_INFO_2 = BluetoothServiceInfo(
    name="GV5121195A",
    address="C1:37:37:32:0F:45",
    rssi=-36,
    manufacturer_data={
...
GVH5122_PASSIVE_2_SERVICE_INFO = BluetoothServiceInfo(
    name="D2:32:39:37:56:34",
    address="D2:32:39:37:56:34",
    rssi=-68,
    manufacturer_data={
...
GVH5122_BUTTON_0_SERVICE_INFO = BluetoothServiceInfo(
    name="GV51225634",
    address="C1:37:37:32:0F:45",
    rssi=-36,
    manufacturer_data={
...
GVH5123_OPEN_SERVICE_INFO = BluetoothServiceInfo(
    name="GV51230B3D",
    address="C1:37:37:32:0F:45",
    rssi=-36,
    manufacturer_data={
...
GVH5123_CLOSED_SERVICE_INFO = BluetoothServiceInfo(
    name="GV51230B3D",
    address="C1:37:37:32:0F:45",
    rssi=-36,
    manufacturer_data={
...
GVH5125_BUTTON_0_SERVICE_INFO = BluetoothServiceInfo(
    name="GV51255367",
    address="C1:37:37:32:0F:45",
    rssi=-36,
    manufacturer_data={
...
GVH5125_BUTTON_1_SERVICE_INFO = BluetoothServiceInfo(
    name="GV51255367",
    address="C1:37:37:32:0F:45",
    rssi=-36,
    manufacturer_data={
...
GVH5126_BUTTON_SERVICE_INFO = BluetoothServiceInfo(
    name="GV51260F45",
    address="C1:37:37:32:0F:45",
    rssi=-36,
    manufacturer_data={
...
GVH5126_BUTTON_0_SERVICE_INFO = BluetoothServiceInfo(
    name="GV51260F45",
    address="C1:37:37:32:0F:45",
    rssi=-36,
    manufacturer_data={
...
GVH5191_SERVICE_INFO = BluetoothServiceInfo(
    name="GVH5191_AC3D",
    address="4125DDBA-2774-4851-9889-6AADDD4CAC3D",
    rssi=-56,
    manufacturer_data={
...
GVH5112_SERVICE_INFO_PROBE_1 = BluetoothServiceInfo(
    name="GV5112AC3D",
    address="4125DDBA-2774-4851-9889-6AADDD4CAC3D",
    rssi=-56,
...
GVH5112_SERVICE_INFO_PROBE_2 = BluetoothServiceInfo(
    name="GV5112AC3D",
    address="4125DDBA-2774-4851-9889-6AADDD4CAC3D",
    rssi=-56,
...
GVH5112_SERVICE_INFO_PROBE_1_ERROR = BluetoothServiceInfo(
    name="GV5112AC3D",
    address="4125DDBA-2774-4851-9889-6AADDD4CAC3D",
    rssi=-56,
    manufacturer_data={1: b"\x01\x01\x03\x49\x28\xe4\x00\x41"},
    service_uuids=["0000ec88-0000-1000-8000-00805f9b34fb"],
    service_data={},
    source="local",
)

GVH5112_SERVICE_INFO_PROBE_2_ERROR = BluetoothServiceInfo(
    name="GV5112AC3D",
    address="4125DDBA-2774-4851-9889-6AADDD4CAC3D",
    rssi=-56,
...
def test_gvh5140():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5140_SERVICE_INFO
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5140_2():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5140_SERVICE_INFO_2
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5140_3():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5140_SERVICE_INFO_3
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5140_error():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5140_SERVICE_INFO_ERROR
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5106_freezing():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5106_FREEZING_SERVICE_INFO
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5106_invalid():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5106_INVALID_SERVICE_INFO
...
def test_gvh5110_1():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5110_SERVICE_INFO_1
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5110_2():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5110_SERVICE_INFO_2
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5110_3():
    ...
    service_info = BluetoothServiceInfo(
        name="GVH5110_4A33",
        address="D4:0E:86:06:4A:33",
        rssi=-71,
        manufacturer_data={
            1: b"\x01\x01\x82\xf7\xfdd",
            76: b"\x02\x15INTELLI_ROCKS_HWPu\xf2\xff\x0c",
        },
        service_uuids=["0000ec88-0000-1000-8000-00805f9b34fb"],
        service_data={},
...
def test_gvh5121_motion():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5121_MOTION_SERVICE_INFO
    result = parser.update(service_info)
...
def test_gvh5121_motion_2():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5121_MOTION_SERVICE_INFO_2
    result = parser.update(service_info)
    assert parser.button_count == 0
    assert parser.sensor_type is SensorType.MOTION
    assert result == SensorUpdate(
...
def test_gvh5122_button_0():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5122_BUTTON_0_SERVICE_INFO
    result = parser.update(service_info)
...
def test_gvh5122_passive_button_0():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5122_PASSIVE_SERVICE_INFO
    result = parser.update(service_info)
    assert parser.button_count == 1
    assert parser.sensor_type is SensorType.BUTTON
    assert result == SensorUpdate(
...
def test_gvh5122_passive_2_button_0():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5122_PASSIVE_2_SERVICE_INFO
    result = parser.update(service_info)
    assert parser.button_count == 1
    assert parser.sensor_type is SensorType.BUTTON
    assert result == SensorUpdate(
...
def test_gvh5123_open():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5123_OPEN_SERVICE_INFO
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5123_closed():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5123_CLOSED_SERVICE_INFO
    result = parser.update(service_info)
    assert parser.button_count == 0
...
def test_gvh5126_button_1():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5126_BUTTON_SERVICE_INFO
    result = parser.update(service_info)
...
def test_gvh5126_button_0():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5126_BUTTON_0_SERVICE_INFO
    result = parser.update(service_info)
    assert parser.button_count == 2
    assert parser.sensor_type is SensorType.BUTTON
    assert result == SensorUpdate(
...
def test_gvh5125_button_0():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5125_BUTTON_0_SERVICE_INFO
    result = parser.update(service_info)
...
def test_gvh5125_button_1():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5125_BUTTON_1_SERVICE_INFO
    result = parser.update(service_info)
    assert parser.button_count == 6
    assert parser.sensor_type is SensorType.BUTTON
    assert result == SensorUpdate(
...
def test_gvh5191():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5191_SERVICE_INFO
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5112_probe_1():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5112_SERVICE_INFO_PROBE_1
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
        ...
        entity_descriptions={
            ...
            DeviceKey(key="humidity_probe_1", device_id=None): SensorDescription(
                device_key=DeviceKey(key="humidity_probe_1", device_id=None),
                device_class=DeviceClass.HUMIDITY,
                native_unit_of_measurement=Units.PERCENTAGE,
            ),
            DeviceKey(key="battery", device_id=None): SensorDescription(
        ...
        entity_values={
            ...
            DeviceKey(key="humidity_probe_1", device_id=None): SensorValue(
                device_key=DeviceKey(key="humidity_probe_1", device_id=None),
...
def test_gvh5112_probe_2():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5112_SERVICE_INFO_PROBE_2
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5112_probe_unknown():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5112_SERVICE_INFO_PROBE_UNKNOWN
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5112_probe_1_error():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5112_SERVICE_INFO_PROBE_1_ERROR
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
...
def test_gvh5112_probe_2_error():
    parser = GoveeBluetoothDeviceData()
    service_info = GVH5112_SERVICE_INFO_PROBE_2_ERROR
    result = parser.update(service_info)
    assert result == SensorUpdate(
        title=None,
        devices={
